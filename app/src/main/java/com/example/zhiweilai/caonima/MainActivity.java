...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView taskName, creator, recipent, start, deadline, note, equip, points;
...
//        d.setContentView(R.layout.layout_show_info_task);
        ...
        taskName=(TextView)d.findViewById(R.id.Text_add1);
        creator=(TextView)d.findViewById(R.id.Text_add2);
        recipent=(TextView)d.findViewById(R.id.Text_add_re);
        start=(TextView)d.findViewById(R.id.Text_add3);
        deadline=(TextView)d.findViewById(R.id.Text_add4);
        note=(TextView)d.findViewById(R.id.Text_add5);
        equip=(TextView)d.findViewById(R.id.Text_add6);
        points=(TextView)d.findViewById(R.id.Text_add8);
